            ...
            <form method="post">
                ...
                $id =$_GET['id'];
                    if(isset($_POST['submit'])) {
                        ...
                        tgl_peminjaman='$tgl_peminjaman', tgl_pengembalian='$tgl_pengembalian',status_peminjaman='$status_peminjaman' WHERE id_peminjaman=$id");
                    ...
                    $query = mysqli_query($koneksi, "SELECT*FROM peminjam WHERE id_peminjaman=$id");
